...
1. **[nn.DataParallel ](./dataparallel.py) 简单方便的 nn.DataParallel**

2. **[torch.distributed](./distributed.py) 使用 torch.distributed 加速并行训练**

3. **[torch.multiprocessing](./multiprocessing_distributed.py) 使用 torch.multiprocessing 取代启动器**

4. **[apex](./apex_distributed.py) 使用 apex 再加速**

5. **[horovod](./horovod_distributed.py)** **horovod 的优雅实现**
...
![img](./v2-9c129a594c73aa8f2085dd17701de0e2_hd.jpg)
...
在 ImageNet 上的完整训练代码，请点击[Github](./dataparallel.py)。
...
在 ImageNet 上的完整训练代码，请点击[Github](./distributed.py)。
...
在 ImageNet 上的完整训练代码，请点击[Github](./multiprocessing_distributed.py)。
...
在 ImageNet 上的完整训练代码，请点击[Github](./apex_distributed.py)。
...
在 ImageNet 上的完整训练代码，请点击[Github](./horovod_distributed.py)。