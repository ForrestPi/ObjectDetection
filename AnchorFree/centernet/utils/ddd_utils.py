...
def project_to_image_nuscenes(pts_3d, P):
  # pts_3d: n x 3
  # P: 3 x 3
  # return: n x 2
  print(pts_3d.shape)
  print(P.shape)
  pts_2d = np.dot(P, pts_3d.T).transpose(1, 0)
  pts_2d = pts_2d[:, :2] / pts_2d[:, 2:]
  # import pdb; pdb.set_trace()
...
def draw_box_3d(image, corners, c=(0, 0, 255)):
  """
  we can change a method to drawing this
  """
  face_idx = [[0,1,5,4],
              [1,2,6, 5],
              [2,3,7,6],
...
def unproject_2d_to_3d_nuscenes(pt_2d, depth, P):
  """
