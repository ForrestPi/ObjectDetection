...
DATA_PATH = '/media/jintain/sg1/permanent/datasets/KITTI/object'
...
for SPLIT in SPLITS:
  ...
  for split in splits:
    ...
    for line in image_set:
      ...
      if DEBUG:
        img_p = os.path.join(DATA_PATH, 'training/image_2', image_info['file_name'])
        print('showing image: {}'.format(img_p))
