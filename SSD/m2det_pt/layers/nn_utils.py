...
def check_argu(key, value):
    ...
    if key == 'backbone':
        assert value in ['vgg16', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
                         'se_resnet50', 'se_resnet101', 'senet154', 'se_resnet152', 'se_resnext50_32x4d',
                         'se_resnext101_32x4d'], 'Not implemented yet!'  # you can do this yourself

    elif key == 'net_family':
        assert value in ['vgg', 'res', 'se'], 'Only support vgg and res family Now'
    elif key == 'base_out':
